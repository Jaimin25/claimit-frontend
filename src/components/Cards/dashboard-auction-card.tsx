    ...
    <div>
      <Card>
        <div className="flex flex-col lg:flex-row">
          <div>
            <div className="flex h-52 w-full items-center justify-center rounded-tl-md rounded-tr-md bg-gray-200 lg:h-full lg:w-44 lg:rounded-bl-md lg:rounded-tr-none">
              <LuImageOff size={24} />
            </div>
          </div>
          <div>
